...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "se\022M\n\016GetFeientLists\022\034.fixbug.GetFriendL"
...
void UserServiceRpc::GetFeientLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendListRequest*,
                         ::fixbug::GetFriendListResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GetFeientLists() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::GetFeientLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
